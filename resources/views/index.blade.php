            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="banner-title">
                        <h1 class="text-uppercase light-txt m-bot-10 inline-block">think wiser</h1>
                        <h3 class="text-uppercase light-txt m-bot-30 inline-block">we are massive for general </h3>
                    </div>
                </div>
            </div>
        </div>
